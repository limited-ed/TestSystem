...
@Component({
  ...
  template: ` <div class="card flex justify-end p-2">
        <ul class="flex list-none m-0 p-0 gap-2 items-center">
            <li>

                        <div class="themeSwitch">
            <input type="checkbox" id="switch" [checked]="themeState().darkTheme" (change)="enableDark($event)" />
            <label for="switch" class="bg-white dark:bg-gray-800 border-1 border-gray-400">
                <div class="elem bg-gray-800 dark:bg-gray-200">
                    <i class="pi pi-sun text-white top-[5px] left-[4px]"></i>
                    <i class="pi pi-moon dark:text-gray-800 top-[5px] left-[5px]"></i>
                </div>
            </label>
        </div>
            </li>
            <li class="relative">
                ...
                <div class="absolute top-[2.5rem] right-0 hidden w-[18rem] p-3 bg-white dark:bg-surface-800 rounded-md shadow border border-surface-200 dark:border-surface-700 flex-col justify-start items-start gap-3.5 origin-top z-10">
                    <div class="flex-col justify-start items-start gap-2 inline-flex pr-4">
                        <span class="text-sm font-medium" i18n>Primary Colors</span>
                    ...
                    <div class="flex-col justify-start items-start gap-2 inline-flex pr-2 mt-4">
                        <span class="text-sm font-medium" i18n>Surface Colors</span>
                    ...
                    <div class="flex-col justify-start items-start gap-2 inline-flex w-full mt-4">
                        <span class="text-sm font-medium" i18n>Preset</span>
                    ...
                    <div class="inline-flex flex-col justify-start items-start gap-2 w-full pt-4 pb-2">
                        <span class="text-sm font-medium m-0" i18n>Ripple Effect</span>
...
export class ThemeSwitcher {
  ...
  loadthemeState(): any {
    if (isPlatformBrowser(this.platformId)) {
      ...
      if (storedState) {
        let ret=JSON.parse(storedState);
        return ret;
      }
    }
    return {
